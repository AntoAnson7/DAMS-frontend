...
import './ScoreCommon.css';

const Score = ({ score=9.2 }) => {
  ...
  const renderProgress = () => {
    ...
    return (
      <circle
        className="c-progress-ring-circle"
  ...
  return (
    <div className="c-score-main">
        <div className="c-score-container">
          <svg viewBox="0 0 120 120" className="c-score-svg">
            <circle
              className="c-progress-ring"
              stroke="#e6e6e6"
              strokeWidth="8"
              fill="transparent"
              r="50"
          ...
          <div className="c-score-value" style={{ color: getColor() }}>
